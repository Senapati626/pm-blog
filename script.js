...
<p>The leadership approach used by the cosmetics giant L'Oréal is another illustration from real life.
    ...
    and belonging as a result of this purposefulness. L'Oréal also encourages a culture of incentives and
    recognition that recognises and celebrates the accomplishments of both individuals and teams. This
    fosters a supportive and inspiring work atmosphere where staff members feel valued and motivated to
    succeed.</p>
<p>
    In conclusion, inspiring and involving project teams requires excellent leadership. Businesses like
    Google and L'Oréal have had success putting tactics that make the most of team strengths, encourage
    cooperation, and cultivate a happy work atmosphere into practise. The data shows how strong leadership
...
<p>In order to manage project risks and solve issues that develop during the project lifetime, leadership is
    ...
    decision-making, and corrective action when required. Additionally, leaders are adept at solving
    problems and navigating complicated circumstances, which helps the team succeed by offering direction
    and support. Projects may face several difficulties without competent leadership, which could result in
    interruptions, overruns of funds, or even project failure. </p>
<p>
    Project leadership skills that are effective at managing risks and solving problems have a big impact on
    how projects turn out. To guarantee project success, a smart leader is aware of the significance of
    proactive risk detection, mitigation, and problem-solving strategies. Leaders can reduce the negative
    effects of uncertainty and direct the project in the direction of its goals by identifying possible
    dangers and putting suitable procedures into place. </p>
<p>
    Elon Musk's aircraft manufacturing and space transporter firm SpaceX is one instance of a business that
    excels at risk management and problem-solving. By creating reusable rockets and bringing down the price
    of space launches, SpaceX has completely changed the space sector. Significant dangers come with this
    novel strategy, but SpaceX's management has successfully handled these challenges.</p>
<p>
    The management of SpaceX is aware of the dangers of space missions, including the possibility of rocket
    failure, technical difficulties, and financial limitations. They give the project lifecycle's many
    phases in-depth analysis in order to give risk identification priority. For instance, SpaceX performs
    thorough examination and simulation to find and fix any possible mechanical problems prior to launch. By
    taking preemptive measures, they can reduce hazards and raise the dependability of their rockets.</p>
<p>
    Additionally, SpaceX has efficient backup preparations in place to handle unforeseen circumstances. As
    an illustration, they created a hydraulic grid fin pump that can manage malfunctions during rocket
    landings. This back-up system makes sure that the rockets can still land securely on Earth regardless of
    whether one of its hydraulic pumps fails (Elon Musk's spacex launch site threatens wildlife, Texas
    environmental groups say, 2021).</p>
<p>
    The leadership of SpaceX has shown tremendous flexibility and agility in problem-solving. When faced
    with difficulties, such as unsuccessful rocket launches, they swiftly pinpoint the underlying causes and
    put the necessary remedies in place. For instance, following an unsuccessful launching in 2015, SpaceX
    looked into the problem, found a defective strut, and made design modifications to stop similar
    incidents in the future. They were able to acquire knowledge from their errors and increase the
    dependability of their rocket by using this method to solving issues.</p>
<p>
    The efficiency of SpaceX's risk administration and problem-solving techniques is further supported by
    statistics. SpaceX had launched and safely landed their Falcon 9 rocket 89 times out of 93 efforts as of
    September 2021, reaching a remarkable success record of over 95%. This high success rate is evidence of
    their effective problem-solving skills and strong risk administration procedures.</p>
<p>
    In conclusion, strong leadership is essential for projects to succeed in terms of risk management and
    problem-solving. The value of preemptive detection of risks, emergency preparedness, and adaptable
    problem-solving strategies is demonstrated by businesses like SpaceX. Such tactics enable leaders to
    reduce risks, assure prompt decision-making, and lead their teams through challenges. A concrete
    illustration of the benefits of effective management for controlling risks and resolving issues within a
    project is provided by the figures from SpaceX's outstanding success record.
</p>`, `<h3>Conclusion</h3>
<p>In conclusion, successful project management depends critically on strong leadership. Successful project
    outcomes are a result of leaders who set a clear direction and goal for the project, inspire and involve
    their teams, and successfully manage risks and problem-solving. Strong leadership has a positive effect
    on the project's achievement and market success, as seen by real-world examples from businesses like
    Apple, Tesla, Google, and SpaceX. Organisations may maximise an opportunity of their teams, boost
    productivity, and lead to successful project outcomes by prioritising leadership development and putting
    into practise effective tactics.</p>
<h3>References</h3>
<ul>
    <li>Martins, J. (2022) Interested in project management? master these 25 skills [2022], Asana. Available
        at:
        <a href="https://asana.com/resources/project-management-skills"
            target="_blank">https://asana.com/resources/project-management-skills</a>
        (Accessed: 16 June 2023).
    </li>
    <li>
        Tannenbaum, S. and Salas, E. (2020) ‘Team members’, Teams That Work, pp. 192–195.
        doi:10.1093/oso/9780190056964.003.0013.
        Project-Management.com (2023) How to write smart goals for project management: 2023 guide, project.
        Available at: <a href="https://project-management.com/smart-goals/"
            target="_blank">https://project-management.com/smart-goals/</a>
        (Accessed: 16 June 2023).</li>
    <li>How Apple is organized for Innovation (2023) Harvard Business Review. Available at:
        <a href="https://hbr.org/2020/11/how-apple-is-organized-for-innovation"
            target="_blank">https://hbr.org/2020/11/how-apple-is-organized-for-innovation</a>
        (Accessed: 16 June 2023).
    </li>
    <li>
        Barboza, D. (2016) An iPhone’s journey, from the factory floor to the retail store, The New York
        Times.
        Available at: <a href="https://www.nytimes.com/2016/12/29/technology/iphone-china-apple-stores.html"
            target="_blank">https://www.nytimes.com/2016/12/29/technology/iphone-china-apple-stores.html</a>
        (Accessed: 16
        June 2023).</li>
    <li>
        Kendra Cherry, Mse. (2023) How do transformational leaders inspire and motivate followers?, Verywell
        Mind. Available at: <a
            href="https://www.verywellmind.com/what-is-transformational-leadership-2795313"
            target="_blank">https://www.verywellmind.com/what-is-transformational-leadership-2795313</a>
        (Accessed:
        16 June 2023).</li>
    <li>
        Duhigg, C. (2016) What google learned from its quest to build the perfect team, The New York Times.
        Available at:
        <a href="https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html"
            target="_blank">https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html</a>
        (Accessed: 16 June 2023).
    </li>
    <li>
        Home (2023) MindTools. Available at:
        <a href="https://www.mindtools.com/abhkwcn/risk-analysis-and-risk-management"
            target="_blank">https://www.mindtools.com/abhkwcn/risk-analysis-and-risk-management</a>
        (Accessed: 16 June 2023).
    </li>
    <li>
        Elon Musk’s spacex launch site threatens wildlife, Texas environmental groups say (2021) The
        Guardian.
        Available at:
        <a href="https://www.theguardian.com/environment/2021/sep/05/texas-spacex-elon-musk-environment-wildlife"
            target="_blank">https://www.theguardian.com/environment/2021/sep/05/texas-spacex-elon-musk-environment-wildlife</a>
        (Accessed: 16 June 2023).
    </li>
</ul>`]
...
function nextPage() {
    ...
    currentPage++
    currentPage < 5 ? document.getElementById("current").innerText = currentPage : null
...
function previousPage() {
    let currentPage = parseInt(document.getElementById("current").textContent)
    currentPage--
    currentPage > 0 ? document.getElementById("current").innerText = currentPage : null
    displayContent(currentPage)
    scrollToTop()
}
